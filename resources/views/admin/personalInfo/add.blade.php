...
@section('content')
    ...
    <div class="content-wrapper">
        <div class="container-xxl flex-grow-1 container-p-y">
            <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Personal Information /</span> Add You Informatio</h4>
            <!-- Content -->
            <form action="{{ route('personalinfo.store') }}" method="POST" enctype="multipart/form-data">
                @csrf
                    ...
                    <div class="card-body">
                        ...
                        <div>
                            ...
                            <input type="text" class="form-control" id="headline" name="headline"
                                aria-describedby="defaultFormControlHelp" value="{{ old('headline') }}" />
                        </div>
