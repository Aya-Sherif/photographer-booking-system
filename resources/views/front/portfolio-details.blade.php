...
@section('content')
    ...
    <section class="portfolio-hero-section set-bg" data-setbg="{{ asset('front') }}/img/portfolio/details/details-hero.jpg">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <div class="ph-text">
    ...
    <section class="portfolio-details-section spad">
        ...
        <div class="portfolio-pics">
            <div class="portfolio-details-pic">
                <div class="pdp-item set-bg" data-setbg="{{ asset('front') }}/img/portfolio/details/details-pic/dp-1.jpg"></div>
                <div class="pdp-item set-bg large-width large-height"
                    data-setbg="{{ asset('front') }}/img/portfolio/details/details-pic/dp-2.jpg"></div>
                <div class="pdp-item set-bg large-width" data-setbg="{{ asset('front') }}/img/portfolio/details/details-pic/dp-3.jpg"></div>
                <div class="pdp-item set-bg" data-setbg="{{ asset('front') }}/img/portfolio/details/details-pic/dp-4.jpg"></div>
                <div class="pdp-item set-bg" data-setbg="{{ asset('front') }}/img/portfolio/details/details-pic/dp-5.jpg"></div>
                <div class="pdp-item set-bg" data-setbg="{{ asset('front') }}/img/portfolio/details/details-pic/dp-6.jpg"></div>
            </div>
        </div>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-3 col-md-6 col-sm-6">
                    <div class="rp-item">
                        <img src="{{ asset('front') }}/img/recent-photography/rp-1.jpg" alt="">
                        <div class="rp-text">
                            <h5>SPRING GARDEN</h5>
                            <span>Lifestyle</span>
                        </div>
                ...
                <div class="col-lg-3 col-md-6 col-sm-6">
                    <div class="rp-item">
                        <img src="{{ asset('front') }}/img/recent-photography/rp-2.jpg" alt="">
                        <div class="rp-text">
                            <h5>SPRING GARDEN</h5>
                            <span>Fashion</span>
                        </div>
                ...
                <div class="col-lg-3 col-md-6 col-sm-6">
                    <div class="rp-item">
                        <img src="{{ asset('front') }}/img/recent-photography/rp-3.jpg" alt="">
                        <div class="rp-text">
                            <h5>SPRING GARDEN</h5>
                            <span>Natural</span>
                        </div>
                ...
                <div class="col-lg-3 col-md-6 col-sm-6">
                    <div class="rp-item">
                        <img src="{{ asset('front') }}/img/recent-photography/rp-4.jpg" alt="">
                        <div class="rp-text">
                            <h5>SPRING GARDEN</h5>
                            <span>Animal</span>
                        </div>
